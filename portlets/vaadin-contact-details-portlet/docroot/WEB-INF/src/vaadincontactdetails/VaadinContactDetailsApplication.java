...
public class VaadinContactDetailsApplication extends Application {

	private static final long serialVersionUID = 1L;

	private static String[] fields = { "First Name", "Last Name", "Company", "Mobile Phone", "Work Phone", "Home Phone", "Work Email", "Home Email", "Street",
	...
	private void initLayout() {
		...
		splitPanel.setHeight(300, Sizeable.UNITS_PIXELS);
	...
	private static IndexedContainer createDummyData() {
		...
		String[] lnames = { "Smith", "Gordon", "Simpson", "Brown", "Clavel", "Simons", "Verne", "Scott", "Allison", "Gates", "Rowling", "Barks", "Ross",
				"Schneider", "Tate" };
